...
urlpatterns = [
    ...
    path(
        "multiplesystemsestimation/examples", views.MultipleSystemsEstimationExamplesView.as_view(), name="mse_examples"
    ),
    path("multiplesystemsestimation/setup", views.MultipleSystemsEstimationSetup.as_view(), name="mse_setup"),
